<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recovery.aspx.cs" Inherits="kakatiyacements.Recovery" Async="true" %>
                        ...
                        <div class="breadcrumb-box">
                            ...
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Password assistance</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-box3">
                            ...
                            <div class="item-heading">
                                <h2 class="item-title">Password assistance</h2>
                            </div>
                            <br />
                            <form class="message-box" runat="server" >
                                <div class="row gutters-10">
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <asp:Button  runat="server" Text="Search" class="item-btn disabled" ID="recovery" OnClick="recovery_Click"/>
                                    </div>
