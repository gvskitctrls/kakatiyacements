<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCommunicationswithShareholders.aspx.cs" Inherits="kakatiyacements.Admin.AddCommunicationswithShareholders" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Communications with Shareholders</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Communications with Shareholders</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
               <h2>Add Communications with Shareholders</h2><br />
                 <form runat="server">
                       <div class="row g-3">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                       ...
                       <label for="TitleModel" style=" position: relative;left: 5%;">Title</label>
                         <div class="col-10">
                          <input type="text"  class=" form-control" id="TitleModel" name="TitleModel" placeholder="Title" required  />
                        </div>
                    <br />
   ...
   <script>
    ...
    <script src="../js/AddCommunicationswithShareholders.js"></script>
</body>
