<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisclosureUnderRegulation302015.aspx.cs" Inherits="kakatiyacements.Admin.DisclosureUnderRegulation302015" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                <h2>Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</h2>
  <br />
                 <form runat="server">
                       <div class="row g-3">
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Title</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
    ...
    <script src="../js/AddDisclosureUnderRegulation302015.js"></script>
</body>
