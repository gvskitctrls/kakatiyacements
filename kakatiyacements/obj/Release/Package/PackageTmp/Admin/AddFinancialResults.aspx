<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFinancialResults.aspx.cs" Inherits="kakatiyacements.Admin.AddFinancialResults" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Financial Results</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add  Financial Results</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<br />
   ...
   <script>
    ...
    <script src="../js/AddFinancialResults.js"></script>
</body>
