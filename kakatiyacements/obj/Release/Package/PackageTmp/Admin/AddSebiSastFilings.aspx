<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSebiSastFilings.aspx.cs" Inherits="kakatiyacements.Admin.AddSebiSastFilings" %>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add SEBI (Sast) Filings</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add SEBI (Sast) Filings</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                 ...
                 <form runat="server">
                     <h2>Add SEBI (Sast) Filings</h2>
                     <br />
                       <div class="row g-3">
                               <div class="col-lg-3 form-group">
                                      <input type="text"  class="col-lg-12 form-control" id="Heading" name="Heading" placeholder="Heading" required />
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Title</th><th>Headings</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                     <label for="HeadingModel" style=" position: relative;left: 5%;">Heading</label>
                        <div class="col-10">
                         <input type="text"  class="form-control" id="HeadingModel" required  >
                       </div>
                   <br />
   ...
   <script>
    ...
    <script src="../js/AddSebiSastFilings.js"></script>
</body>
</html>
