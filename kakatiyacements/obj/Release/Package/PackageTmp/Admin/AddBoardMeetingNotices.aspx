<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBoardMeetingNotices.aspx.cs" Inherits="kakatiyacements.Admin.AddBoardMeetingNotices" %>
...
<li><a href="AddUser.aspx" id="adminListItem" runat="server">Admin</a></li>
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Board Meeting Notices</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Board Meeting Notices</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
               <h2>Add Board Meeting Notices</h2>
                <br />
                 <form runat="server">
                       <div class="row g-3">
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Quaterly</th><th>Start Year</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
   ...
   <script>
    ...
    <script src="../js/AddBoardMeetingNotices.js"></script>
</body>
