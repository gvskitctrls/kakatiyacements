<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBookClosure.aspx.cs" Inherits="kakatiyacements.Admin.AddBookClosure" %>
...
<li><a href="AddUser.aspx" id="adminListItem" runat="server">Admin</a></li>
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Book Closure</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Book Closure</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
   ...
   <script>
    ...
    <script src="../js/AddBookClosure.js"></script>
</body>
</html>
