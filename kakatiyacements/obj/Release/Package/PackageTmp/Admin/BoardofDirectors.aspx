<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BoardofDirectors.aspx.cs" Inherits="kakatiyacements.Admin.BoardofDirectors" %>
   ...
   <div class="item-number" id="userDetails" runat="server"></div>
       ...
       <li>
          ...
          <ul class="dropdown-menu-col-1">
              ...
              <li><a href="#">Scrutinizers Report</a></li>
              <li><a href="#">Reconciliation of Share Capital Audit</a></li>
              <li><a href="#">SEBI (Sast) Filings</a></li>
              <li><a href="#">SEBI (PIT) SDD Compliance Certificates </a></li>
              <li><a href="#">Related Party Transactions</a></li>
          </ul>
      </li>
      <li>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Board Of Directors</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Board Of Directors</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
             ...
             <div style=" font-weight: 500;">
                   <a href="AddDesignations.aspx" style="position: relative;left: 80%;">Add Designations</a>
               </div>
                 <br />
                <br /> 
                       <div class="row g-3">
                               <div class="col-lg-3 form-group">
                                    <select name="Designation" id="Designation" class="col-lg-12 form-control" >
                               ...
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Role" placeholder="Role" required />
                                </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Designation</th><th>Name</th><th>Role</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                       <label for="DesignationModel"  style=" position: relative;left: 5%;">Designation</label>
                             <div class="col-10">
                              <input type="text"  class="form-control" id="DesignationModel" required disabled>
                            </div>
                        <br />
                   ...
                   <br />
                  <label for="RoleModel" style=" position: relative;left: 5%;">Role</label>
                    <div class="col-10">
                      <input type="text" class="form-control" id="RoleModel"  required>
                    </div>
                  <br />
    ...
    <script src="../js/AddBoardMembers.js"></script>
</body>
