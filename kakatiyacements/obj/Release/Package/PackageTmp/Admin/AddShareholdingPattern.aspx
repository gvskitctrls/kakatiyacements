<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddShareholdingPattern.aspx.cs" Inherits="kakatiyacements.Admin.AddShareholdingPattern" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Shareholding Pattern</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Shareholding Pattern</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
               <h2>Add Shareholding Pattern</h2>
                <br />
                 <form runat="server">
                       <div class="row g-3">
   ...
   <script>
    ...
    <script src="../js/AddShareholdingPattern.js"></script>
</body>
