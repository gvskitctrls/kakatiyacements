<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateUnderRegulation40(10).aspx.cs" Inherits="kakatiyacements.Admin.CertificateUnderRegulation40_10_" %>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Certificate Under Regulation 40 (10)</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Certificate Under Regulation 40 (10)</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                 ...
                 <form runat="server">
                     <h2>Add Certificate Under Regulation 40 (10)</h2>
                     <br />
                       <div class="row g-3">
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Title</th><th>Start Year</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
   ...
   <script>
    ...
    <script src="../js/AddCertificateUnderRegulation40(10).js"></script>
</body>
</html>
