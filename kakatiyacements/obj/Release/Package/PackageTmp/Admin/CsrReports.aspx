<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CsrReports.aspx.cs" Inherits="kakatiyacements.Admin.CsrReports" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Csr Reports</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Csr Reports</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
   ...
   <script>
    ...
    <script src="../js/AddCsrReports.js"></script>
</body>
