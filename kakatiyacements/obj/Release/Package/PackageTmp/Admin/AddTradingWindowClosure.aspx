<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTradingWindowClosure.aspx.cs" Inherits="kakatiyacements.Admin.AddTradingWindowClosure" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Trading Window Closure</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Trading Window Closure</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
               <h2>Add Trading Window Closure</h2>
                <br />
                 <form runat="server">
                       <div class="row g-3">
   ...
   <script>
    ...
    <script src="../js/AddTradingWindowClosure.js"></script>
</body>
