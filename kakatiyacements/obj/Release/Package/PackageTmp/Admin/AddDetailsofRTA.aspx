<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDetailsofRTA.aspx.cs" Inherits="kakatiyacements.Admin.AddDetailsofRTA" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
  ...
  <li><a href="AddNoticesofGeneralMeetings.aspx">Add Notices of General Meetings</a></li>
              <li><a href="AddGeneralAnnouncements.aspx">Add General Announcements</a></li>
      </ul>
      </li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Details of RTA</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Details of RTA</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
          ...
          <h2>Add Details of RTA</h2>
<br />
                       <div class="row g-3">
                  <%-- id, name, designation, Address, Number, mail--%>
                               <div class="col-lg-4 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="name" name="name" placeholder="Name" required />
                             
                                </div>
                               <div class="col-lg-4 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="ContactPerson" name="ContactPerson" placeholder="Contact Person" required />
                                </div>
                               <div class="col-lg-4 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Address" placeholder="Address" name="Address" required />
                                </div>
                               <div class="col-lg-4 form-group">
                                  <input type="text"  class="col-lg-12 form-control" id="Number" name="Number" placeholder="Number" required />
                             </div>
                            <div class="col-lg-4 form-group">
                                  <input type="text"  class="col-lg-12 form-control" id="mail" placeholder="mail" name="Mail" required />
                             </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Name</th><th>Contact Person</th><th>Address</th><th>Number</th><th>Mail</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                     <label for="nameModel" style=" position: relative;left: 5%;">Name</label>
                        <div class="col-10">
                         <input type="text"  class="form-control" id="nameModel" required >
                       </div>
                   <br />
                  <label for="ContactPersonModel" style=" position: relative;left: 5%;">Contact Person</label>
                    <div class="col-10">
                     <input type="text"  class="form-control" id="ContactPersonModel" required >
                    </div>
                  <br />
                  <label for="AddressModel" style=" position: relative;left: 5%;">Address</label>
                    <div class="col-10">
                      <input type="text" class="form-control" id="AddressModel"  required>
                    </div>
                  <br />
                 <label for="NumberModel" style=" position: relative;left: 5%;">Number</label>
                   <div class="col-10">
                     <input type="text" class="form-control" id="NumberModel"  required>
                   </div>
                 <br />
                      <label for="mailModel" style=" position: relative;left: 5%;">Mail</label>
                   <div class="col-10">
                     <input type="text" class="form-control" id="mailModel"  required>
                   </div>
                 <br />
                 </div>
    ...
    <script src="../js/AddDetailsofRTA.js"></script>
