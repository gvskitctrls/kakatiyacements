<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCertificateUnderRegulation7(3).aspx.cs" Inherits="kakatiyacements.Admin.AddCertificateUnderRegulation7_3_" %>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add CCertificate Under Regulation 7 (3)</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Certificate Under Regulation 7 (3)</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                 ...
                 <form runat="server">
                     <h2>Add Certificate Under Regulation 7 (3)</h2>
                     <br />
                       <div class="row g-3">
   ...
   <script>
    ...
    <script src="../js/AddCertificateUnderRegulation7(3).js"></script>
</body>
</html>
