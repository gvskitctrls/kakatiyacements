<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShareholdersInformation.aspx.cs" Inherits="kakatiyacements.Admin.ShareholdersInformation" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Shareholders Information</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Shareholders Information</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
             <h2>Add Shareholders Information</h2><br />
                       <div class="row g-3">
                               
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Title" name="Title" placeholder="Title" required />
                                  
                                </div>
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Link" name="Link" placeholder="Add Link" required />
                                </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Title</th><th>Link</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                     <label for="TitleModel" style=" position: relative;left: 5%;">Title</label>
                        <div class="col-10">
                         <input type="text"  class="form-control" id="TitleModel" required >
                       </div>
                   <br />
                  <label for="LinkModel" style=" position: relative;left: 5%;">Add Link</label>
                    <div class="col-10">
                      <input type="text" class="form-control" id="LinkModel"  required>
                    </div>
                  <br />
    ...
    <script src="../js/AddShareholdersInformation.js"></script>
</body>
