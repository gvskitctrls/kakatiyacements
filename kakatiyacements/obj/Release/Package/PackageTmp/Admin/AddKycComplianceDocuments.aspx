<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddKycComplianceDocuments.aspx.cs" Inherits="kakatiyacements.Admin.AddKycComplianceDocuments" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add KYC Compliance Documents</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add KYC Compliance Documents</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                <h2>Add KYC Compliance Documents</h2>
  <br />
                 <form runat="server">
                       <div class="row g-3">
                   
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Particulars" name="Particulars" placeholder="Particulars" required />
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Particulars</th><th>Title</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                     <label for="ParticularsModel" style=" position: relative;left: 5%;">Particulars</label>
                        <div class="col-10">
                         <input type="text"  class="form-control" id="ParticularsModel" required >
                       </div>
                   <br />
    ...
    <script src="../js/AddKycComplianceDocuments.js"></script>
