<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CareersData.aspx.cs" Inherits="kakatiyacements.Admin.CareersData" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Careers Details</h1>
                            <nav>
                                <ol class="breadcrumb">
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Name</th><th>Email</th><th>Phone Number</th><th>Subject</th></tr>
                        </thead>
                    <tbody id="mailData">
