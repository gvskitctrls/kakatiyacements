<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="kakatiyacements.Admin.AddUser" %>
...
<li><a href="AddContactData.aspx">Contact Details</a></li>
<li><a href="../HrData/GetCareesData.aspx">Hr Deatils</a></li>
 <li><a href="AddDisclosure.aspx">Investors</a></li>
...
<br />
                       ...
                       <div class="row g-3" >
                           <div class="col-lg-3 form-group">
                            <select name="Designation" id="Designation" class="col-lg-12 form-control" >
                               ...
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="username" name="username" placeholder="Username" required />
                             
                                </div>
                               
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="password" name="password" placeholder="Password" required />
                                </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Username</th><th>Password</th><th>Designation</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                     <label for="usernameModel" style=" position: relative;left: 5%;">Username</label>
                        <div class="col-10">
                         <input type="text"  class="form-control" id="usernameModel" required >
                       </div>
                   <br />
                 
                  <label for="passwordModel" style=" position: relative;left: 5%;">Password</label>
                    <div class="col-10">
