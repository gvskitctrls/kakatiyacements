<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="kakatiyacements.Login" %>
...
.field-icon__eye-slash {
    display: none; /* Initially hide the slashed eye icon */
}

/* Adjust the styles for the toggle button as per your design */
.toggle-password {
    background: none;
    border: none;
    outline: none;
...
<body class="sticky-header">
                            ...
                            <form class="message-box" runat="server" >
                                <div class="row gutters-10">
                                    <div class="col-lg-12 form-group">
                                        <input type="email" class="form-control" name="username" placeholder="Username" data-error="" required>
                                    ...
                                    <div class="col-lg-12 form-group">
                                       ...
                                       <div class="position-relative">
                                        <input type="password" class="form-control" name="password" id="password" placeholder="Password" data-error="" required>
                                        <span toggle="#password" class="eye field-icon toggle-password">
                                            <i class="fa fa-fw fa-eye field-icon__eye"></i>
                                            <i class="fa fa-fw fa-eye-slash field-icon__eye-slash"></i>
                                        </span>
                                    </div>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <asp:Button  runat="server" Text="Login" class="item-btn disabled" ID="loginData" OnClick="loginData_Click"/>
                                    </div>
                                    <div class="form-group col-lg-6" style="align-content: center;">
    ...
    <script>
        $(document).on('click', '.toggle-password', function () {
            $(this).toggleClass('field-icon__show');
