...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "AddOutcomeofBoardMeeting.asmx/OutcomeofBoardMeetingData",
...
function updateData() {
    ...
    d.open("POST", "AddOutcomeofBoardMeeting.asmx/updateOutcomeofBoardMeetingData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "AddOutcomeofBoardMeeting.asmx/deleteOutcomeofBoardMeetingData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
