...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "SEBI(PIT)SDDComplianceCertificates.asmx/SEBISDDComplianceCertificatesData",
...
function updateData() {
    ...
    d.open("POST", "SEBI(PIT)SDDComplianceCertificates.asmx/updateSEBISDDComplianceCertificatesData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "SEBI(PIT)SDDComplianceCertificates.asmx/deleteSEBISDDComplianceCertificatesData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
