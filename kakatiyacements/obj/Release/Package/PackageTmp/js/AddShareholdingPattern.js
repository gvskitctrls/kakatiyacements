...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "ShareholdingPattern.asmx/ShareholdingPatternData",
...
function updateData() {
    ...
    d.open("POST", "ShareholdingPattern.asmx/updateShareholdingPatternData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "ShareholdingPattern.asmx/deleteShareholdingPatternData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
