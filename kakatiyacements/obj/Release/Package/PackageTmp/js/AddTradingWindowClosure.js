...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "TradingWindowClosure.asmx/TradingWindowClosureData",
...
function updateData() {
    ...
    d.open("POST", "TradingWindowClosure.asmx/updateTradingWindowClosureData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "TradingWindowClosure.asmx/deleteTradingWindowClosureData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
