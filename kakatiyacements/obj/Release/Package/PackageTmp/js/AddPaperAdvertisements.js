...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "PaperAdvertisements.asmx/PaperAdvertisementsData",
...
function updateData() {
    ...
    d.open("POST", "PaperAdvertisements.asmx/updatePaperAdvertisementsData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "PaperAdvertisements.asmx/deletePaperAdvertisementsData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
