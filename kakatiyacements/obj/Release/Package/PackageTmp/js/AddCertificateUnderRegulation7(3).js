...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "CertificateUnderRegulation7(3).asmx/CertificateUnderRegulation73Data",
...
function updateData() {
    ...
    d.open("POST", "CertificateUnderRegulation7(3).asmx/updateCertificateUnderRegulation73Data", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "CertificateUnderRegulation7(3).asmx/deleteCertificateUnderRegulation73Data", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
