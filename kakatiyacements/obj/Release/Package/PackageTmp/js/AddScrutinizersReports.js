...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "ScrutinizersReports.asmx/ScrutinizersReportsData",
...
function updateData() {
    ...
    d.open("POST", "ScrutinizersReports.asmx/updateScrutinizersReportsData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "ScrutinizersReports.asmx/deleteScrutinizersReportsData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
