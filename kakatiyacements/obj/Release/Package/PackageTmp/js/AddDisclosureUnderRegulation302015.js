...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "AddDisclosureUnderRegulation302015.asmx/DisclosureUnderRegulationData",
...
function updateData() {
    ...
    d.open("POST", "AddDisclosureUnderRegulation302015.asmx/updateDisclosureUnderRegulationData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "AddDisclosureUnderRegulation302015.asmx/deleteDisclosureUnderRegulationData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
