...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "RelatedPartyTransactions.asmx/RelatedPartyTransactionsData",
...
function updateData() {
    ...
    d.open("POST", "RelatedPartyTransactions.asmx/updateRelatedPartyTransactionsData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "RelatedPartyTransactions.asmx/deleteRelatedPartyTransactionsData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
