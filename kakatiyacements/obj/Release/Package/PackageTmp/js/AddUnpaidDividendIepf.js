...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "UnpaidDividendIepf.asmx/UnpaidDividendIepfData",
...
function updateData() {
    ...
    d.open("POST", "UnpaidDividendIepf.asmx/updateUnpaidDividendIepfData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "UnpaidDividendIepf.asmx/deleteUnpaidDividendIepfData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
