...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "CorporateGovernanceReport.asmx/CorporateGovernanceReportData",
...
function updateData() {
    ...
    d.open("POST", "CorporateGovernanceReport.asmx/updateCorporateGovernanceReportData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "CorporateGovernanceReport.asmx/deleteCorporateGovernanceReportData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
