...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "ReconciliationOfShareCapitalAudit.asmx/ReconciliationOfShareCapitalAuditData",
...
function updateData() {
    ...
    d.open("POST", "ReconciliationOfShareCapitalAudit.asmx/updateReconciliationOfShareCapitalAuditData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "ReconciliationOfShareCapitalAudit.asmx/deleteReconciliationOfShareCapitalAuditData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
