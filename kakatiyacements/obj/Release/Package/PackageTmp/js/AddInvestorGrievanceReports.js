...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "InvestorGrievanceReports.asmx/InvestorGrievanceReportsData",
...
function updateData() {
    ...
    d.open("POST", "InvestorGrievanceReports.asmx/updateInvestorGrievanceReportsData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "InvestorGrievanceReports.asmx/deleteInvestorGrievanceReportsData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
