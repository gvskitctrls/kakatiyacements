...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "CommunicationswithShareholders.asmx/CommunicationswithShareholdersData",
...
function updateData() {
    ...
    d.open("POST", "CommunicationswithShareholders.asmx/updateCommunicationswithShareholdersData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "CommunicationswithShareholders.asmx/deleteCommunicationswithShareholdersData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
