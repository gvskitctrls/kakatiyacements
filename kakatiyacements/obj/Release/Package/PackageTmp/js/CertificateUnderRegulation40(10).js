...
var dataBind = ` <div class="">
     <h4 class="section-title">Certificate Under Regulation 40 (10)</h4>
 </div>`;
...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "Admin/AddCertificateUnderRegulation40(10).asmx/CertificateUnderRegulation4010Data",
     ...
     <thead class="thead-dark">
         <tr>
             <th scope="col">Year ${StratYearType}</th>
         </tr>
     </thead>
     <tbody>`;
