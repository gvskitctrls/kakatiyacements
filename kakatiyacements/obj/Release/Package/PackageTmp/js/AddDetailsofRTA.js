function addDataToTable() {
    ...
    if (name != "" && ContactPerson != "" && Address != "" && Number != "" && mail != "") {
        var n = new XMLHttpRequest();
        n.open("POST", "DetailsofRTA.asmx/DetailsofRTADataInsert", true);
...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "DetailsofRTA.asmx/DetailsofRTAData",
...
function updateData() {
    ...
    var ContactPerson = document.getElementById('ContactPersonModel').value;
    ...
    d.open("POST", "DetailsofRTA.asmx/updateDetailsofRTAData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "DetailsofRTA.asmx/deleteDetailsofRTAData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
