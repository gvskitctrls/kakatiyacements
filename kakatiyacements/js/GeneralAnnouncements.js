...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "GeneralAnnouncements.asmx/NoticesofGeneralMeetingsData",
...
function updateData() {
    ...
    d.open("POST", "GeneralAnnouncements.asmx/updateNoticesofGeneralMeetingsData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "GeneralAnnouncements.asmx/deleteNoticesofGeneralMeetingsData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
