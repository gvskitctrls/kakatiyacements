...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "SecretarialComplianceReports.asmx/SecretarialComplianceReportsData",
...
function updateData() {
    ...
    d.open("POST", "SecretarialComplianceReports.asmx/updateSecretarialComplianceReportsData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "SecretarialComplianceReports.asmx/deleteSecretarialComplianceReportsData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
