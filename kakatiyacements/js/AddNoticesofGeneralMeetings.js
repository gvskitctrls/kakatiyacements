...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "NoticesofGeneralMeetings.asmx/NoticesofGeneralMeetingsData",
...
function updateData() {
    ...
    d.open("POST", "NoticesofGeneralMeetings.asmx/updateNoticesofGeneralMeetingsData", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "NoticesofGeneralMeetings.asmx/deleteNoticesofGeneralMeetingsData", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
