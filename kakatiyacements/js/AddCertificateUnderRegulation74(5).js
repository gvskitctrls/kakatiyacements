...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "CertificateUnderRegulation74(5).asmx/CertificateUnderRegulation745Data",
...
function updateData() {
    ...
    d.open("POST", "CertificateUnderRegulation74(5).asmx/updateCertificateUnderRegulation745Data", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "CertificateUnderRegulation74(5).asmx/deleteCertificateUnderRegulation745Data", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
