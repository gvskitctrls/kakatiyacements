...
function dataLoad() {
    $.ajax({
        type: "POST",
        url: "AddCertificateUnderRegulation40(10).asmx/CertificateUnderRegulation4010Data",
...
function updateData() {
    ...
    d.open("POST", "AddCertificateUnderRegulation40(10).asmx/updateCertificateUnderRegulation4010Data", !0);
...
function deleteRecord() {
    ...
    var t = Number(e);
    var d = new XMLHttpRequest;
    d.open("POST", "AddCertificateUnderRegulation40(10).asmx/deleteCertificateUnderRegulation4010Data", true);
    d.setRequestHeader("Content-Type", "application/json");
    var l = {
        id: t
    };
