<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact-us.aspx.cs" Inherits="kakatiyacements.contact_us" %>
...
<head>
    ...
    <style>
        .breadcrumb-wrap {
            background-image: url(img/strips/contact.jpg);
...
<body class="sticky-header">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="case-box2" style="margin-bottom: 10px;">
                                    <div class="">
                                        <img src="img/contact-us.jpg" alt="service">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row gutters-40">
                    <div class="col-lg-6">
                        <div class="contact-box2">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15228.309667460519!2d78.4899075!3d17.408072!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb99e850000001%3A0xa18f56090762889a!2sKakatiya%20Cement%20Sugar%20%26%20Industries%20Limited!5e0!3m2!1sen!2sin!4v1716198657685!5m2!1sen!2sin" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="contact-box3">
                            <div class="contact-bg-image">
                                <img src="img/figure94.png" alt="figure" width="266" height="214">
                            </div>
                            ...
                            <form class="message-box" runat="server" >
                                ...
                                <div class="row gutters-10">
                                    ...
                                    <div class="col-lg-6 form-group">
                                        <input type="text" class="form-control" name="phone" placeholder="Phone" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"  required>
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <textarea name="message" id="message" class="form-control" placeholder="Comments" cols="30" rows="6" required></textarea>
                                   ...
                                   <div class="col-lg-12 form-group" >
                                    ...
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <asp:Button  runat="server" ID="submit" Text="Send message" class="item-btn" OnClick="submit_Click" OnClientClick="return data();"/>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="footer-list2">
                                            ...
                                            <li><a href="careers.aspx"><i class="fas fa-angle-right"></i>Careers</a></li>
    ...
    <script src="js/ContactInfoDetails.js"></script>
</body>
