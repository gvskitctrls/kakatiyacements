<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDisclosure.aspx.cs" Inherits="kakatiyacements.Admin.AddDisclosure" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Disclosure</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Disclosure</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                     <h2>Add Disclosure</h2>
<br />
                 
                       <div class="row g-3">
                   
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Information" name="Information" placeholder="Information" required />
                             
                                </div>
                               <div class="col-lg-3 form-group">
                                    <select name="Applicability" id="Applicability" class="col-lg-12 form-control" >
                               ...
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="WebsiteLink" placeholder="WebsiteLink" required />
                                </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Information</th><th>Applicability</th><th>Website Location</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                     <label for="InformationModel" style=" position: relative;left: 5%;">Information</label>
                        <div class="col-10">
                         <input type="text"  class="form-control" id="InformationModel" required >
                       </div>
                   <br />
                  <label for="ApplicabilityModel" style=" position: relative;left: 5%;">Applicability</label>
                    <div class="col-10">
                     <select name="Applicability" id="ApplicabilityModel" class="col-lg-12 form-control" >
                            <option value="">select Applicability</option>
                            <option value="Y">Yes</option>
                            <option value="N">No</option>
                            <option value="NA">NA</option>
                  ...
                  <br />
                  <label for="WebsiteLinkModel" style=" position: relative;left: 5%;">Website Link</label>
                    <div class="col-10">
                      <input type="text" class="form-control" id="WebsiteLinkModel"  required>
                    </div>
                  <br />
    ...
    <script src="../js/AddDisclosure.js"></script>
</body>
