...
{
    public partial class AddSEBI_PIT_SDDComplianceCertificates : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/SEBISDDComplianceCertificates/";
                ...
                string path = "Admin/investors/SEBISDDComplianceCertificates/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO SEBISDDComplianceCertificates(StratYear, EndYear, Quaterly, Path) VALUES(@StratYear, @EndYear, @Quaterly, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddSEBI(PIT)SDDComplianceCertificates.aspx", false);
                    }
