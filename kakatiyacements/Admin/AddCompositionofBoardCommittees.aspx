<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCompositionofBoardCommittees.aspx.cs" Inherits="kakatiyacements.Admin.AddCompositionofBoardCommittees" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Composition of Board Committees</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Composition of Board Committees</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                <h2>Add Composition of Board Committees</h2><br />
             <div style=" font-weight: 500;">
                   <a href="AddCommittees.aspx" style="position: relative;left: 80%;">Add Committees</a>
               </div>
                 <br />
                <br /> 
                       <div class="row g-3">
                               <div class="col-lg-3 form-group">
                                    <select name="Committee" id="Committee" class="col-lg-12 form-control" >
                               ...
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Designation" placeholder="Designation" required />
                                </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Committee</th><th>Name</th><th>Designation</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                       <label for="CommitteeModel"  style=" position: relative;left: 5%;">Committee</label>
                             <div class="col-10">
                              <input type="text"  class="form-control" id="CommitteeModel" required disabled>
                            </div>
                        <br />
    ...
    <script src="../js/AddCompositionofBoardCommittees.js"></script>
</body>
