<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCommittees.aspx.cs" Inherits="kakatiyacements.Admin.AddCommittees" %>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Committees</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Committees</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                 ...
                 <h2>Add Committees</h2><br />
                       <div class="row g-3">
                   
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Committee" name="Committee" placeholder="Committee" required />
                                </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Committees</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                     <label for="CommitteeModel" style=" position: relative;left: 5%;">Committee</label>
                        <div class="col-10">
                         <input type="text"  class="form-control" id="CommitteeModel" required >
                       </div>
                   <br />
                 </div>
    ...
    <script src="../js/AddCommittee.js"></script>
