...
{
    public partial class AddNoticesofGeneralMeetings : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/NoticesofGeneralMeetings/";
                ...
                string path = "Admin/investors/NoticesofGeneralMeetings/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO NoticesofGeneralMeetings(Title, Path) VALUES(@Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddNoticesofGeneralMeetings.aspx", false);
                    }
