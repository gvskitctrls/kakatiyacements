...
{
    public partial class OutcomeofBoardMeeting : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/OutcomeofBoardMeeting/";
                ...
                string path = "Admin/investors/OutcomeofBoardMeeting/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO OutcomeofBoardMeeting(StratYear, EndYear, Quaterly, Path) VALUES(@StratYear, @EndYear, @Quaterly, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("OutcomeofBoardMeeting.aspx", false);
                    }
