...
{
    public partial class AddSecretarialComplianceReports : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/SecretarialComplianceReports/";
                ...
                string path = "Admin/investors/SecretarialComplianceReports/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO SecretarialComplianceReports(StratYear, Title, Path) VALUES(@StratYear, @Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddSecretarialComplianceReports.aspx", false);
                    }
