...
{
    public partial class AddGeneralAnnouncements : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/GeneralAnnouncements/";
                ...
                string path = "Admin/investors/GeneralAnnouncements/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO GeneralAnnouncements(Title, Path) VALUES(@Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddGeneralAnnouncements.aspx", false);
                    }
