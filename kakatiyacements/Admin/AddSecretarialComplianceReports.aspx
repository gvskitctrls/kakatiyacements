<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSecretarialComplianceReports.aspx.cs" Inherits="kakatiyacements.Admin.AddSecretarialComplianceReports" %>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Secretarial Compliance Reports</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Secretarial Compliance Reports</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                 ...
                 <form runat="server">
                     <h2>Add Secretarial Compliance Reports</h2>
                     <br />
                       <div class="row g-3">
   ...
   <script>
    ...
    <script src="../js/AddSecretarialComplianceReports.js"></script>
</body>
</html>
