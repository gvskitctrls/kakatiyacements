...
{
    public partial class AddBookClosure : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/BookClosure/";
                ...
                string path = "Admin/investors/BookClosure/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO BookClosure(StratYear, Title, Path) VALUES(@StratYear, @Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddBookClosure.aspx", false);
                    }
