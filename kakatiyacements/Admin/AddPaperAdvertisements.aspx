<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPaperAdvertisements.aspx.cs" Inherits="kakatiyacements.Admin.AddPaperAdvertisements" %>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Paper Advertisements</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Paper Advertisements</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                 ...
                 <form runat="server">
                     <h2>Add Paper Advertisements</h2>
                     <br />
                       <div class="row g-3">
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Title</th><th>Start Year</th><th>End Year</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
   ...
   <script>
    ...
    <script src="../js/AddPaperAdvertisements.js"></script>
</body>
</html>
