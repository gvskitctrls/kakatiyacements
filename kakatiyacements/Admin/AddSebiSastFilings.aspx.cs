...
{
    public partial class AddSebiSastFilings : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            {
                string Heading = Page.Request.Form["Heading"].ToString();
                string Title = Page.Request.Form["Title"].ToString();
                MySqlConnection connection = new MySqlConnection(connectionString);
                string uploadFolderRelative = "investors/SebiSastFilings/";
                ...
                string path = "Admin/investors/SebiSastFilings/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO SebiSastFilings(Heading,Title,Path) VALUES(@Heading, @Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddSebiSastFilings.aspx", false);
                    }
