...
{
    public partial class AddCertificateUnderRegulation74_5_ : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/CertificateUnderRegulation745/";
                ...
                string path = "Admin/investors/CertificateUnderRegulation745/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO CertificateUnderRegulation745(StratYear, EndYear, Quaterly, Path) VALUES(@StratYear, @EndYear, @Quaterly, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddCertificateUnderRegulation74(5).aspx", false);
                    }
