...
{
    public partial class AddPaperAdvertisements : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/PaperAdvertisements/";
                ...
                string path = "Admin/investors/PaperAdvertisements/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO PaperAdvertisements(StratYear, EndYear, Title, Path) VALUES(@StratYear, @EndYear, @Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddPaperAdvertisements.aspx", false);
                    }
