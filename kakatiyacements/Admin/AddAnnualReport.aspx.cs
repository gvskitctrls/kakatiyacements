...
{
    public partial class AddAnnualReport : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/AnnualReport/";
                ...
                string path = "Admin/investors/AnnualReport/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO AnnualReport(StratYear, EndYear, Title, Path) VALUES(@StratYear, @EndYear, @Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddAnnualReport.aspx", false);
                    }
