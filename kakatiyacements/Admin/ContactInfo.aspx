<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactInfo.aspx.cs" Inherits="kakatiyacements.ContactInfo" %>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
                    ...
                    <br />
                       ...
                       <div class="row g-3">
                               ...
                               <div class="col-lg-3 form-group">
                                     <select name="Office" id="Office" class="col-lg-12 form-control" required >
                                        <option value="">---select Office---</option>
                                         <option value="Regd Office">Regd Office</option>
                                          <option value="Cement Works">Cement Works</option>
                                          <option value="Sugar Works">Sugar Works</option>
                                    </select>
                                </div>
                                <div class="col-lg-3 form-group">
                                     <select name="locatphone" id="locatphone" class="col-lg-12 form-control" required >
                               ...
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Data" name="Data" placeholder="Data" required />
                                </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Office</th><th>Contact Details</th><th>Data</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                       <label for="OfficeModel"  style=" position: relative;left: 5%;">Office</label>
                             <div class="col-10">
                              <input type="text"  class="form-control" id="OfficeModel" required disabled>
                            </div>
                        <br />
                     <label for="locatphoneModel" style=" position: relative;left: 5%;">Contact Data</label>
                        <div class="col-10">
                          <input type="text"  class="form-control" id="locatphoneModel" required disabled>
                       </div>
                   <br />
                  <label for="DataModel" style=" position: relative;left: 5%;">Data</label>
                    <div class="col-10">
                      <input type="text" class="form-control" id="DataModel"  required>
                    </div>
                  <br />
