...
{
    public partial class AddUnpaidDividendIepf : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/UnpaidDividendIepf/";
                ...
                string path = "Admin/investors/UnpaidDividendIepf/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO UnpaidDividendIepf(Title, Path) VALUES(@Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddUnpaidDividendIepf.aspx", false);
                    }
