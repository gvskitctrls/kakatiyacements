<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAgmEgmProceedings.aspx.cs" Inherits="kakatiyacements.Admin.AddAgmEgmProceedings" %>
...
<li><a href="AddUser.aspx" id="adminListItem" runat="server">Admin</a></li>  
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add AGM/EGM Proceedings</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add AGM/EGM Proceedings</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
   ...
   <script>
    ...
    <script src="../js/AddAgmEgmProceedings.js"></script>
</body>
</html>
