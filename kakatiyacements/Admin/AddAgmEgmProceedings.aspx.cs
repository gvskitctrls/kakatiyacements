...
{
    public partial class AddAgmEgmProceedings : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/AgmEgmProceedings/";
                ...
                string path = "Admin/investors/AgmEgmProceedings/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO AgmEgmProceedings(StratYear, Title, Path) VALUES(@StratYear, @Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddAgmEgmProceedings.aspx", false);
                    }
