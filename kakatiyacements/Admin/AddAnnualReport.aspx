<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAnnualReport.aspx.cs" Inherits="kakatiyacements.Admin.AddAnnualReport" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Annual Report</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Annual Report</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
   ...
   <script>
    ...
    <script src="../js/AddAnnualReport.js"></script>
</body>
