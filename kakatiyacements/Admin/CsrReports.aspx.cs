...
{
    public partial class CsrReports : System.Web.UI.Page
    {
        ...
        {//id, StratYear, EndYear, Title, Path
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/CsrReports/";
                ...
                string path = "Admin/investors/CsrReports/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO CsrReports(StratYear, EndYear, Title, Path) VALUES(@StratYear, @EndYear, @Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("CsrReports.aspx", false);
                    }
