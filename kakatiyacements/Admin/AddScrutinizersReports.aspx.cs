...
{
    public partial class AddScrutinizersReports : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/ScrutinizersReports/";
                ...
                string path = "Admin/investors/ScrutinizersReports/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO ScrutinizersReports(Title, Path) VALUES(@Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddScrutinizersReports.aspx", false);
                    }
