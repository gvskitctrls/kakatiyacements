...
{
    public partial class AddCorporateGovernanceReport : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/CorporateGovernanceReport/";
                ...
                string path = "Admin/investors/CorporateGovernanceReport/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO CorporateGovernanceReport(StratYear, EndYear, Quaterly, Path) VALUES(@StratYear, @EndYear, @Quaterly, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddCorporateGovernanceReport.aspx", false);
                    }
