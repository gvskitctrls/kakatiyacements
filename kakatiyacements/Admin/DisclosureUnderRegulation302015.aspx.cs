...
{
    public partial class DisclosureUnderRegulation302015 : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/DisclosureUnderRegulation302015/";
                ...
                string path = "Admin/investors/DisclosureUnderRegulation302015/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO DisclosureUnderRegulation302015(Title, Path) VALUES(@Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("DisclosureUnderRegulation302015.aspx", false);
                    }
