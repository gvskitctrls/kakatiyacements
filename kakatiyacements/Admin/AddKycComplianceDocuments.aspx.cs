...
{
    public partial class AddKycComplianceDocuments : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            {
                string Particulars = Page.Request.Form["Particulars"].ToString();
                string Title = Page.Request.Form["Title"].ToString();
                MySqlConnection connection = new MySqlConnection(connectionString);
                string uploadFolderRelative = "investors/KycComplianceDocuments/";
                ...
                string path = "Admin/investors/KycComplianceDocuments/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO KycComplianceDocuments(Particulars, Path,Title) VALUES(@Particulars, @Path,@Title)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddKycComplianceDocuments.aspx", false);
                    }
