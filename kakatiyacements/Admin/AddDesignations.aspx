<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDesignations.aspx.cs" Inherits="kakatiyacements.Admin.AddDesignations" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Designations</h1>
                            <nav>
                                <ol class="breadcrumb">
...
<br />     
                       ...
                       <div class="row g-3">
                               ...
                               <div class="col-lg-3 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="Designations" name="Designations" placeholder="Designations" required />
                                </div>
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Designations</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                     <label for="DesignationsModel" style=" position: relative;left: 5%;">Designations</label>
                        <div class="col-10">
                         <input type="text"  class="form-control" id="DesignationsModel" required >
                       </div>
                   <br />
                 </div>
    ...
    <script src="../js/AddDesignations.js"></script>
</body>
