<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSEBI(PIT)SDDComplianceCertificates.aspx.cs" Inherits="kakatiyacements.Admin.AddSEBI_PIT_SDDComplianceCertificates" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add SEBI (PIT) SDD Compliance Certificates</h1>
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add SEBI (PIT) SDD Compliance Certificates</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <section class="about-wrap-layout1">
            <div class="container">
               <h2>Add SEBI (PIT) SDD Compliance Certificates</h2>
                <br />
                 <form runat="server">
                       <div class="row g-3">
   ...
   <script>
    ...
    <script src="../js/AddSEBI(PIT)SDDComplianceCertificates.js"></script>
</body>
