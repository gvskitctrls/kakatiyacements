...
{
    public partial class AddCertificateUnderRegulation7_3_ : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            if (fileUpload.HasFile)
            {
                ...
                string uploadFolderRelative = "investors/CertificateUnderRegulation73/";
                ...
                string path = "Admin/investors/CertificateUnderRegulation73/" + fileName;
                try
                {
                    fileUpload.SaveAs(filePath);
                    //id, Title, Path
                    MySqlCommand command = new MySqlCommand("INSERT INTO CertificateUnderRegulation73(StratYear, Title, Path) VALUES(@StratYear, @Title, @Path)", connection);
                    ...
                    if (rowsAffected > 0)
                    {
                        Response.Redirect("AddCertificateUnderRegulation7(3).aspx", false);
                    }
