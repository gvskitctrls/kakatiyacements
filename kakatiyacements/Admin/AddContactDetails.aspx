<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddContactDetails.aspx.cs" Inherits="kakatiyacements.Admin.AddContactDetails" %>
...
<li><a href="DisclosureUnderRegulation302015.aspx">Add Disclosure Under Regulation 30 Of SEBI (Lodr) Regulations 2015</a></li>
 ...
 <li><a href="../index.html">Logout</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb-box">
                            <h1 class="page-title">Add Contact Details</h1>
                            <nav>
                                <ol class="breadcrumb">
            ...
            <div class="container">
               <h2>Add Contact Details</h2><br />
                  ...
                  <%-- id, name, designation, Address, Number, mail--%>
                               ...
                               <div class="col-lg-4 form-group">
                                     <input type="text"  class="col-lg-12 form-control" id="designation" name="designation" placeholder="Designation" required />
                                </div>
                               <div class="col-lg-4 form-group">
                ...
                <table id="mail-Data" class="table table-striped border-bottom" >
                    ...
                    <tr><th>S.No</th><th>Name</th><th>Designation</th><th>Address</th><th>Number</th><th>Mail</th><th>Edit</th><th>Delete</th></tr>
                        </thead>
                    <tbody id="mailData">
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-body" id="modal-body">
                   ...
                   <br />
                  <label for="designationModel" style=" position: relative;left: 5%;">Designation</label>
                    <div class="col-10">
                     <input type="text"  class="form-control" id="designationModel" required >
                    </div>
                  <br />
    ...
    <script src="../js/AddContactDetails.js"></script>
</body>
